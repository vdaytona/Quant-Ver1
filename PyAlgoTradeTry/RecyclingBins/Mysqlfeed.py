...
class Database(dbfeed.Database):
    def __init__oringin(self, dbFilePath):
    ...
    def getBars(self, instrument, frequency, timezone=None, fromDateTime=None, toDateTime=None):
        ...
        sql = "select * from %s " : %talbe_name
        ret = []
        #write anything you want to do in the workingSpace
        pandas_ret = workingSpace(cnx)
        
        convert
        
        dbfeed.Database.getBars(self, instrument, frequency, timezone=timezone, fromDateTime=fromDateTime, toDateTime=toDateTime)
    
    def pandasToSequence(self, pandas_ret):
        pass
    ...
    def addBar__origin(self, instrument, bar, frequency):
    ...
    def getBars_origin(self, instrument, frequency, timezone=None, fromDateTime=None, toDateTime=None):
        instrument = normalize_instrument(instrument)
