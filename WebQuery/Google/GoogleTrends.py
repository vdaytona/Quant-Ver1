...
from 
https://bitbucket.org/mattreid9956/google-trend-api/src/2a9b438109cc6a6b73ebf500728f6ac60a83212a/pyGTrends.py?at=master
@author: purewin7
'''
...
class pyGTrends( object ):
    ...
    def download_report( self, keywords, date='all', geo='all', geor='all', graph = 'all_csv', sort=0, scale=0, sa='N' ):
        ...
        print ('http://www.google.com/trends/viz?' + params )
...
def main():
    ...
    r = pyGTrends(username = "daytonaviola@gmail.com", password="ding198573jie")
    r.download_report(('debt'))
