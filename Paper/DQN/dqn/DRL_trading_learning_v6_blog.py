...
change memory.get_batch
     ...
     3. _blog , add win ration change to the result
...
def run():
    ...
    for e in range(epoch):
        ...
        win_ratio_list.append(float(win_count) / float(trade_count))
        logging.info("accumulate return : " + str(accumulate_ret[-1]) + " : win ratio : " + str(float(win_count) / float(trade_count)))
    ...
    result["win ratio"] = win_ratio_list
