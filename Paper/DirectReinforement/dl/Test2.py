...
3. Training data is used as first 2000 days, then update the parameters using UPDATE_STEP 3 after each 100 days.
4. Used the parameters in trained model to make decision 


learning method for last 30 time unit return look back : 
